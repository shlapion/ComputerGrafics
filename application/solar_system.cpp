...
glm::mat4 sunSize = glm::scale(glm::mat4{}, glm::vec3{10.90f});  // scaled down
  ...
  model_matrixSun = glm::translate(model_matrixSun, glm::vec3{0.0f, 0.0f, model_matrixSun[1][1]+log2( 0.0f )}); // radius of the rotation axis defined in AU
  ...
  model_matrixMercury = glm::translate(model_matrixMercury, glm::vec3{ 0.0f, 0.0f, model_matrixMercury[1][1]+log2( 0.4f*AU )}); // radius of the rotation axis defined in AU
  ...
  model_matrixVenus = glm::translate(model_matrixVenus, glm::vec3{ 0.0f, 0.0f, model_matrixVenus[1][1]+log2( 0.7f * AU )}); // radius of the rotation axis defined in AU
  ...
  model_matrixEarth = glm::translate(model_matrixEarth, glm::vec3{ 0.0f, 0.0f, model_matrixEarth[1][1]+log2( AU )}); // radius of the rotation axis defined in AU
  ...
  model_matrixMoon = glm::translate(model_matrixMoon, glm::vec3{ 0.0f, 0.0f, model_matrixMoon[1][1]+log2( 0.2f * AU )}); // radius of the rotation axis defined in AU
  ...
  model_matrixMars = glm::translate(model_matrixMars, glm::vec3{ 0.0f, 0.0f, model_matrixMars[1][1]+log2( 1.5f * AU )}); // radius of the rotation axis defined in AU
  ...
  model_matrixJupiter = glm::translate(model_matrixJupiter, glm::vec3{ 0.0f, 0.0f, model_matrixJupiter[1][1]+log2( 5.2f * AU )}); // radius of the rotation axis defined in AU
  ...
  model_matrixSaturn = glm::translate(model_matrixSaturn, glm::vec3{ 0.0f, 0.0f, model_matrixSaturn[1][1]+log2( 9.5f * AU )}); // radius of the rotation axis defined in AU
  ...
  model_matrixUranus = glm::translate(model_matrixUranus, glm::vec3{ 0.0f, 0.0f, model_matrixUranus[1][1]+log2( 19.2f * AU )}); // radius of the rotation axis defined in AU
  ...
  model_matrixNeptune = glm::translate(model_matrixNeptune, glm::vec3{ 0.0f, 0.0f, model_matrixNeptune[1][1]+log2( 18.0f * AU )}); // radius of the rotation axis defined in AU
